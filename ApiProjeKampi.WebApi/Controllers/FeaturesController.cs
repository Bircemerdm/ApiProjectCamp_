...
namespace ApiProjeKampi.WebApi.Controllers
{
    ...
    public class FeaturesController : ControllerBase
    {
        ...
        private readonly IMapper _mapper; //Imapper interfaceinde bir tane mapper örnekledim
        ...
        [HttpPost]
        public IActionResult CreateFeatureDto(CreateFeatureDto createFeatureDto)
        {
